-- Migration 001: initial schema (users, login_days, focus_sessions, habits,
-- habit_completions, habit_completion_events, exp_events, level_thresholds,
-- ai_reviews). Mirrors src/main/db/schema.sql. Do not edit after release;
